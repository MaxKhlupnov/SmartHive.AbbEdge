...
namespace abbRemoteMonitoringGateway.Services
{
    ...
    {
        private Microsoft.Azure.Devices.Client.DeviceClient internalClient;
        ...
        {
            var sdkClient = Microsoft.Azure.Devices.Client.DeviceClient.CreateFromConnectionString(connectionString, transportType);
        ...
        private IDeviceClientWrapper WrapSdkClient(Microsoft.Azure.Devices.Client.DeviceClient sdkClient)
        {
